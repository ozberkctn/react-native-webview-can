...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.closeUnHighlightPopUp = function () {
            RNCWKWebViewManager.closeUnHighlightPopUp(_this.getWebViewHandle());
        };

        _this.unhighlight =  function (top,left) {
            RNCWKWebViewManager.unhighlight(_this.getWebViewHandle(),top,left);
        };
        /**
